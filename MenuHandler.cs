...
namespace Smeb Rumble
{
    class Menu
    {
        ...
        {
            _menu = new Menu("Smeb Rumble", "menu", true);
            ...
            comboMenu.AddItem(new MenuItem("Rumble.Combo.Q", "Use Q").SetValue(true));
            comboMenu.AddItem(new MenuItem("Rumble.Combo.W", "Use W").SetValue(false));
            comboMenu.AddItem(new MenuItem("Rumble.Combo.E", "Use E").SetValue(true));
            comboMenu.AddItem(new MenuItem("Rumble.Combo.R", "Use R").SetValue(true));
            comboMenu.AddItem(new MenuItem("Rumble.Combo.Count.Enemies", "Enemies in range for R").SetValue(new Slider(2, 1, 5)));
            comboMenu.AddItem(new MenuItem("Rumble.Combo.Ignite", "Use Ignite").SetValue(true));
